<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <EditableElement
          ...
          :openLinkDialog="openLinkDialog"
        />
        <QuadInpaintOverlay v-if="manualInpaint.active" />
      </div>
    </div>
    ...
    <div class="quad-inpaint-toolbar" v-if="manualInpaint.active">
      ...
      <Button :disabled="manualInpaint.submitting" @click="manualInpaint.cancel()">取消</Button>
      <span v-if="manualInpaint.error" class="error">{{ manualInpaint.error }}</span>
    </div>
...
import QuadInpaintOverlay from './QuadInpaintOverlay.vue'
